...
public class MagelangAdapter extends BaseAdapter {
    // params
    ArrayList listItem;
    Activity activity;

    public MagelangAdapter(Activity activity, ArrayList listItem){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = inflater.inflate(R.layout.magelang_list, null);
        ...
        MagelangModel color = (MagelangModel) getItem(position);
