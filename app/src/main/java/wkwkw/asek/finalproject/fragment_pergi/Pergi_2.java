 ...
 */
public class Pergi_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pergi_2, container, false);
        btnSecond = (FloatingActionButton) view.findViewById(R.id.floatingActionButton);

        ((Pergi)getActivity()).getSupportActionBar().setTitle("Tips Berlibur 2");
