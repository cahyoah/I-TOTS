...
public class MalangAdapter extends BaseAdapter {
    // params
    ArrayList listItem;
    Activity activity;

    public MalangAdapter(Activity activity, ArrayList listItem){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = inflater.inflate(R.layout.malang_list, null);
        ...
        MalangModel color = (MalangModel) getItem(position);
